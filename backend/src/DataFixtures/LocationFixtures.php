...
{
    // Données extraites de data/localisations.ts
    const LOCATIONS = [
        [
            'city' => 'Libourne',
            'slug' => 'libourne',
            ...
            'og_url' => 'https://www.as-turing.fr/localisation/developpeur-web-libourne',
        ...
        [
            ...
            'og_url' => 'https://www.as-turing.fr/localisation/developpeur-web-bordeaux',
        ...
        [
            ...
            'og_url' => 'https://www.as-turing.fr/localisation/developpeur-web-saint-emilion',
        ...
        [
            ...
            'og_url' => 'https://www.as-turing.fr/localisation/developpeur-web-creon',
        ...
        [
            ...
            'og_url' => 'https://www.as-turing.fr/localisation/developpeur-web-sauveterre-de-guyenne',
    ...
    {
        foreach (self::LOCATIONS as $locationData) {
            $location = new Location();
            $location->setCity($locationData['city']);
            $location->setSlug($locationData['slug']);
            $location->setTitle($locationData['title']);
            $location->setDescription($locationData['description']);
            $location->setOgTitle($locationData['og_title']);
            $location->setOgDescription($locationData['og_description']);
            $location->setOgUrl($locationData['og_url']);
            $location->setMap($locationData['map']);
