...
async function confirmDelete() {
  if (!props.service) {
    error.value = 'Impossible de supprimer le client: informations manquantes'
    return
  }
  ...
  try {
    ...
    emit('delete-confirmed', props.service.id)
    closeModal()
  } catch (err) {
    error.value = 'Impossible de supprimer le service: informations manquant'
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-4">
              <div class="grid grid-cols-1 gap-2">
                <div class="flex">
                  ...
                  <span class="text-gray-900 dark:text-white">{{ service.title }}</span>
                </div>
                <!--                <div class="flex">-->
                <!--                  <span class="font-medium text-gray-600 dark:text-gray-400 w-24">Email:</span>-->
                <!--                  <span class="text-gray-900 dark:text-white">{{ client.email }}</span>-->
                <!--                </div>-->
                <!--                <div class="flex">-->
                <!--                  <span class="font-medium text-gray-600 dark:text-gray-400 w-24">Entreprise:</span>-->
                <!--                  <span class="text-gray-900 dark:text-white">{{ client.company }}</span>-->
                <!--                </div>-->
              </div>
            </div>
