<template>
  <section class="pt-24 pb-16 gradient-hero text-white overflow-hidden relative min-h-[90vh] flex items-center dark:opacity-95">
    <!-- Background decorations animées avec parallax -->
    <div class="absolute inset-0 opacity-10 parallax-container">
      ...
      <div class="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="space-y-8 hero-content">
          ...
          <div class="flex flex-col sm:flex-row gap-4 fade-in-up" style="animation-delay: 0.5s">
            <NuxtLink
              to="/contact"
              class="group px-8 py-4 bg-white text-primary rounded-full font-semibold hover:bg-gray-100 transition-all text-center shadow-2xl hover:shadow-white/20 hover:scale-105 transform duration-300 relative overflow-hidden cta-glow"
            >
              <span class="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-1000"></span>
            ...
            <NuxtLink
              to="/projets"
              class="group px-8 py-4 border-2 border-white text-white rounded-full font-semibold hover:bg-white/10 transition-all text-center backdrop-blur-sm hover:scale-105 transform duration-300 relative overflow-hidden"
            >
              <span class="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-1000"></span>
              <span class="inline-flex items-center gap-2 relative z-10">
          ...
          <div class="grid grid-cols-3 gap-6 pt-8 border-t border-white/20">
            <div v-for="(stat, index) in stats" :key="stat.label" class="text-center transform hover:scale-110 transition-transform duration-300 stat-item" :style="{ animationDelay: `${0.6 + index * 0.1}s` }">
