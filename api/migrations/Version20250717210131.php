...
final class Version20250717210131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cateogry (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE specification (id INT AUTO_INCREMENT NOT NULL, cateogry_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, placeholder VARCHAR(255) NOT NULL, required TINYINT(1) NOT NULL, pattern VARCHAR(255) NOT NULL, min INT DEFAULT NULL, max INT DEFAULT NULL, error_message LONGTEXT NOT NULL, tooltip LONGTEXT DEFAULT NULL, display_order INT NOT NULL, type_options JSON DEFAULT NULL, INDEX IDX_E3F1A9ACDFA51E8 (cateogry_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE specification ADD CONSTRAINT FK_E3F1A9ACDFA51E8 FOREIGN KEY (cateogry_id) REFERENCES cateogry (id)');
    }
